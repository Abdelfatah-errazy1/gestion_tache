...
<!-- Assign User Modal -->
<div class="modal fade" id="assignUserModal{{ $tache->id }}" tabindex="-1" aria-labelledby="assignUserModalLabel{{ $tache->id }}" aria-hidden="true">
  <div class="modal-dialog">
    <form action="{{ route('taches.assign', $tache->id) }}" method="POST">
      @csrf
      <div class="modal-content">
        <div class="modal-header">
          <h5 class="modal-title">Assign User to Task: {{ $tache->titre }}</h5>
          <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
        </div>
        <div class="modal-body">
          <div class="form-group">
            ...
            <select name="user_id" class="form-control" required>
              ...
              @foreach($users as $user)
                <option value="{{ $user->id }}" @if($tache->user_id == $user->id) selected @endif>
  ...
  <!-- View Modal -->
  <div class="modal fade" id="viewModal{{ $tache->id }}" tabindex="-1" aria-labelledby="viewModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg">
      <div class="modal-content">
        <div class="modal-header">
