                  ...
                  <div class="card">
                    <div class="card-body">
                      <form action="{{ route('prerequis.store') }}" method="POST"> 
                        @csrf                   
                        <div class="d-flex flex-row align-items-center">
                          <input type="text" class="form-control form-control-lg" name="contraint" placeholder="ajouter prerequis">
                          <input type="hidden" value="{{ $model->id }}" class="form-control form-control-lg">
                          <div>
                            <button type="button" class="btn btn-primary">Ajouter</button>
                          </div>
                        </div>
